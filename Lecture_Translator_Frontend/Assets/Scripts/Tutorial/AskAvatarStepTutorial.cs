...
/// <summary>
/// This class represents the ask avatar step of the tutorial.
/// It is the fifth step and it gives the user information on speaking with the AI avatar.
/// </summary>
...
public class AskAvatarStepTutorial : MonoBehaviour, ITutorialStep
{
    ...
    /// <summary>
    /// Completes the step when the dialogue window is opened.
    /// </summary>
