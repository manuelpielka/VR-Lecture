...
/// It is the third step and it gives the user information on the settings and playback controls.
/// </summary>
public class PlaybackControlsStepTutorial : MonoBehaviour, ITutorialStep
{
    ...
    /// <summary>
    /// Completes the step when the lecture player window is opened.
    /// </summary>
