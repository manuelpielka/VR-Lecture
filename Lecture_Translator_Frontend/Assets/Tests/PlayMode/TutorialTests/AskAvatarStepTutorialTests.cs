...
public class AskAvatarStepTutorialTests
{
    [SetUp]
    public void Setup()
    {
    ...
    public void Teardown()
    {
        ...
        foreach (var step in Object.FindObjectsByType<AskAvatarStepTutorial>(FindObjectsSortMode.None))
        {
    ...
    [UnityTest]
    public IEnumerator StartStep_Skips_When_Dialouge_Already_Open()
    {
    ...
    [UnityTest]
    public IEnumerator WindowOpened_Dialouge_Completes_And_CleansUp()
    {
        yield return null; // let scene load
        DisableRuntimePlaybackSystems();
    ...
    [UnityTest]
    public IEnumerator Completion_Fires_Once_When_Both_NextClick_And_Dialouge_Happen()
    {
        yield return null; // let scene load
        DisableRuntimePlaybackSystems();
