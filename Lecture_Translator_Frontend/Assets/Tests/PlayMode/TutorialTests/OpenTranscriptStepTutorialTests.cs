...
public class OpenTranscriptStepTutorialTests
{
    [SetUp]
    public void Setup()
    {
    ...
    public void Teardown()
    {
        ...
        foreach (var step in Object.FindObjectsByType<OpenTranscriptStepTutorial>(FindObjectsSortMode.None))
        {
    ...
    [UnityTest]
    public IEnumerator StartStep_Skips_When_Transcript_Already_Open()
    {
        ...
        wm.OpenWindow("TranscriptWindow"); // ensures IsWindowOpen(MainMenuKey) == true

        var sutGO = new GameObject("WelcomeStep_SUT");
        var sut = sutGO.AddComponent<OpenTranscriptStepTutorial>();
    ...
    public IEnumerator StartStep_CreatesOverlay_And_PositionsIt()
    {
        ...
        typeof(OpenTranscriptStepTutorial)
    ...
    [UnityTest]
    public IEnumerator WindowOpened_Transcript_Completes_And_CleansUp()
    {
        yield return null; // let scene load
        DisableRuntimePlaybackSystems();
        ...
        wm.OpenWindow("TranscriptWindow");
    ...
    [UnityTest]
    public IEnumerator Completion_Fires_Once_When_Both_NextClick_And_TranscriptOpen_Happen()
    {
        yield return null; // let scene load
        DisableRuntimePlaybackSystems();
    ...
    public IEnumerator EndStep_Is_Idempotent()
    {
     ...
     [UnityTest]
    public IEnumerator StartStep_DoesNot_Complete_Without_UserAction_Or_Transcript()
    {
        yield return null; // let scene load
        DisableRuntimePlaybackSystems();
