...
public class PlaybackControlsStepTutorialTests
{
    [SetUp]
    public void Setup()
    {
    ...
    public void Teardown()
    {
        ...
        foreach (var step in Object.FindObjectsByType<PlaybackControlsStepTutorial>(FindObjectsSortMode.None))
        {
    ...
    [UnityTest]
    public IEnumerator StartStep_Skips_When_LecturePlayer_Already_Open()
    {
    ...
    public IEnumerator StartStep_CreatesOverlay_And_PositionsIt()
    {
        ...
        typeof(PlaybackControlsStepTutorial)
    ...
    [UnityTest]
    public IEnumerator WindowOpened_LecturePlayer_Completes_And_CleansUp()
    {
        yield return null; // let scene load
        DisableRuntimePlaybackSystems();
    ...
    [UnityTest]
    public IEnumerator Completion_Fires_Once_When_Both_NextClick_And_LecturePlayerOpen_Happen()
    {
        yield return null; // let scene load
        DisableRuntimePlaybackSystems();
    ...
    public IEnumerator EndStep_Is_Idempotent()
    {
     ...
     [UnityTest]
    public IEnumerator StartStep_DoesNot_Complete_Without_UserAction_Or_LecturePlayer()
    {
        yield return null; // let scene load
        DisableRuntimePlaybackSystems();
