...
public class WelcomeStepTutorialTests
{
    [SetUp]
    public void Setup()
    {
    ...
    public void Teardown()
    {
        ...
        foreach (var step in Object.FindObjectsByType<WelcomeStepTutorial>(FindObjectsSortMode.None))
        {
    ...
    [UnityTest]
    public IEnumerator StartStep_Skips_When_MainMenu_Already_Open()
    {
        ...
        wm.OpenWindow("MainMenuWindow"); // ensures IsWindowOpen(MainMenuKey) == true

        var sutGO = new GameObject("WelcomeStep_SUT");
        var sut = sutGO.AddComponent<WelcomeStepTutorial>();
    ...
    [UnityTest]
    public IEnumerator WindowOpened_MainMenu_Completes_And_CleansUp()
    {
        yield return null; // let scene load
        DisableRuntimePlaybackSystems();
    ...
    [UnityTest]
    public IEnumerator Completion_Fires_Once_When_Both_NextClick_And_MainMenuOpen_Happen()
    {
        yield return null; // let scene load
        DisableRuntimePlaybackSystems();
    ...
    public IEnumerator EndStep_Is_Idempotent()
    {
     ...
     [UnityTest]
    public IEnumerator StartStep_DoesNot_Complete_Without_UserAction_Or_MainMenu()
    {
        yield return null; // let scene load
        DisableRuntimePlaybackSystems();
